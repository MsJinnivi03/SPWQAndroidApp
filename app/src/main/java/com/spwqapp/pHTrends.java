...
public class pHTrends extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phtrends);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    String phStr=arrOfStr[5];
                    int max=6;

                    System.out.println("PH= "+ phStr);

                    while (true) {
                        try {
                            int d = Integer.parseInt(phStr.substring(max-1,max));
                            break;
                    ...
                    float pH=  Float.parseFloat(phStr.substring(1,max));
