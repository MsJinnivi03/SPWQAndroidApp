...
public class TemperatureTrends extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temperature_trends);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    // temperature
                    String tempStr=arrOfStr[4];
                    int max=6;

                    while (true) {
                        try {
                            int d = Integer.parseInt(tempStr.substring(max-1,max));
                            break;
                    ...
                    float temperature=  Float.parseFloat(tempStr.substring(1,max));
                    System.out.println("Temperature= "+temperature);
                    // append value of temp here
                    ...
                    try {
                        ...
                        System.out.println(dateTime+"dateTime Data");
//                        append date here
